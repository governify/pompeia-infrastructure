...
after((done) => {
  ...
  execSync("docker logs bluejay-assets-manager &> tests/logs/asset.log");
  execSync("docker logs bluejay-render &> tests/logs/render.log");
  execSync("docker logs bluejay-reporter &> tests/logs/reporter.log");
  execSync("docker logs bluejay-registry &> tests/logs/registry.log");
  execSync("docker logs bluejay-collector-events &> tests/logs/collector-events.log");
  execSync("docker logs bluejay-dashboard &> tests/logs/dashboard.log");
  execSync("docker logs bluejay-scope-manager &> tests/logs/scope-manager.log");
  execSync("docker logs bluejay-join &> tests/logs/join.log");
  execSync("docker logs bluejay-influx-reporter &> tests/logs/influx.log");
  execSync("docker logs bluejay-mongo-registry &> tests/logs/mongo.log");
  execSync("docker logs bluejay-redis-ec &> tests/logs/redis.log");
  execSync("docker logs bluejay-director &> tests/logs/director.log");
